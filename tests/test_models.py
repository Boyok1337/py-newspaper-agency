...
class RedactorTestCase(TestCase):
    ...
    def test_redactor_ordering(self):
        ...
        self.assertEqual(
            list(get_user_model().objects.all()), [self.redactor, redactor2]
        )
...
class TopicTestCase(TestCase):
    ...
    def test_topic_ordering(self):
        ...
        self.assertEqual(list(Topic.objects.all()), [self.topic, topic2])
...
class ContactFormTestCase(TestCase):
    def setUp(self):
        self.contact_form = ContactForm.objects.create(
            name="Test Name", email="test@example.com", message="Test message"
        )
